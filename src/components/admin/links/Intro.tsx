...
const Intro = () => {
  return (
    <div className='bg-lightestGray dark:bg-darkGray px-5 py-8 rounded-xl space-y-6'>
      ...
      <Paragraph className='text-center max-w-lg mx-auto'>{`Use the “Add new link” button to get started. Once you have more than one link, you can reorder and edit them. We're here to help you share your profiles with everyone!`}</Paragraph>
    </div>
  );
};
