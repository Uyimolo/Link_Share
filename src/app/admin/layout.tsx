        ...
        {pathname === "/admin/analytics" || pathname === "/admin/preview" ? (
          ...
          <div
            className={cn(
              "",
              showPreview
                ? "fixed bottom-0 left-0 top-0 z-30 grid w-screen transition duration-1000  place-content-center bg-lightestGray/50 backdrop-blur lg:relative lg:block lg:w-full lg:place-content-start lg:rounded-xl lg:bg-white lg:py-10 lg:backdrop-filter-none"
