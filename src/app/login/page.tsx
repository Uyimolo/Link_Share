...
const Login = () => {
  ...
  return (
    <div className="grid min-h-screen dark:bg-transparent bg-white p-6 md:bg-transparent md:py-20">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-16">
        ...
        <div className="space-y-8 md:dark:bg-lighterNavy dark:bg-transparent bg-white md:mx-auto md:w-[476px] md:p-10">
